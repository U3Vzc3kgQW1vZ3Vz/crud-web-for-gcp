...
print STDOUT "You've just typed in: ";
print STDOUT "$line_parameters \n";
print STDOUT "Please type again like this:\n";
print STDOUT "perl delay-jitter-calc.pl tracefile-name tcp/udp
send-node receive-node\n";
print STDOUT "(For example: perl delay-jitter-calc.pl chapter5-
sample1.tr tcp 0 5)\n\n";
exit 0;
}
$infile=$ARGV[0];
...
printf("---------------------------------------------------\n");
print STDOUT "Mean delay = ";
print STDOUT "$mean_delay\n";
print STDOUT "Standard deviation of delay = ";
print STDOUT "$dev_delay\n";
#================================================================
close DATA;
exit(0);
